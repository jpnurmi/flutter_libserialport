...
static void flutter_serial_port_plugin_handle_method_call(
...
static void flutter_serial_port_plugin_dispose(GObject* object) {
  G_OBJECT_CLASS(flutter_serial_port_plugin_parent_class)->dispose(object);
}

static void flutter_serial_port_plugin_class_init(FlutterSerialPortPluginClass* klass) {
  G_OBJECT_CLASS(klass)->dispose = flutter_serial_port_plugin_dispose;
}
...
static void method_call_cb(FlMethodChannel* channel, FlMethodCall* method_call,
                           gpointer user_data) {
  FlutterSerialPortPlugin* plugin = FLUTTER_SERIAL_PORT_PLUGIN(user_data);
  flutter_serial_port_plugin_handle_method_call(plugin, method_call);
}
